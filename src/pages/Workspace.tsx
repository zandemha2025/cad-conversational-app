          ...
          <>
            {showLeft && (
              <div className="w-full md:w-72 shrink-0 border-r border-cadsurface-700 overflow-hidden flex flex-col md:flex">
                {leftPanel === 'chat'         && <ChatPanel projectId={projectId} onComponentSuggestions={setComponentSuggestions} onGenerationQueued={() => setIsGenerating(true)} fixtureLoaded={fixtureVersion !== null} />}
