      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-3">
        ...
        {!result && !loading && (
          <div className="text-center py-4 px-2">
            <p className="text-xs text-slate-400 font-medium mb-1">Set your machining parameters above</p>
            <p className="text-xs text-slate-600 leading-relaxed">
              Enter your cut parameters and click Calculate to get Kienzle-based clamping force recommendations.
            </p>
          </div>
        )}
